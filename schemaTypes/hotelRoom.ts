...
const hotelRoom = {
  ...
  fields: [
    ...
    defineField({
      ...
      validation: (Rule) => Rule.required().error("Cover image is needed"),
    }),
    defineField({
      name: "type",
      title: "Room Type",
    ...
    defineField({
      ...
      validation: (Rule) => Rule.required(),
      initialValue:
        "Check-in time is 3PM, check-out time is 11AM. If you leave behind any items, please contact reception.",
    }),
    defineField({
      name: "dimension",
      title: "Dimension",
